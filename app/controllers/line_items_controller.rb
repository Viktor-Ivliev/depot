class LineItemsController < ApplicationController
  include CurrentCart#какраз таки подключаем нашу корзину
  before_action :set_cart, only: [:create]# объявили о том, что метод set_cart() 
  #должен быть вызван до действия create()
